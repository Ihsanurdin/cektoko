    ...
    public function update(Request $request, string $id)
{
    ...
    public function destroy(string $id)
    {
        ...
        if (DB::table('barang')->where('kategori_id', $id)->exists()) {
            return redirect()->route('kategori.index')->with('warning', 'Kategori masih digunakan pada barang. Tidak dapat dihapus.');
        }

        // Hapus kategori jika tidak ada barang yang menggunakan kategori tersebut
